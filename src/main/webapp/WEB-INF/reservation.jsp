...
<br>
<form:label path="parasols" class="col-sm-1 control-label">Parasols</form:label>
<form:select path="parasols" multiple="true">
<form:option value="0">Merci de choisir un ou plusieurs parasols </form:option>
<form:options items="${parasols}" itemValue="id" itemLabel="numEmplacementEtNumeroDeLaFile" />
</form:select>
<form:errors cssClass="erreur" path="parasols"/>
<br>
...
<form:errors cssClass="erreur" path="client"/>
<br>
<br>
