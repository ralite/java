...
import fr.hb.ewan.plages.util.NbInscrits;
...
public interface ClientDao extends JpaRepository<Client, Long> {
	...
	List<Client> findAllByLienDeParente(LienDeParente lienDeParente);
	...
	@Query(value = """
			SELECT new fr.hb.ewan.plages.util.NbInscrits(year(c.dateHeureInscription), month(c.dateHeureInscription), COUNT(c.id))
			FROM Client c
